...
<html lang = "eng">
	<head>
		<title>Equip Ministry | Home</title>
		<meta charset = "utf-8" />
	...
	<body>
		<nav class = "navbar navbar-inverse navbar-fixed-top">
			<div class = "container-fluid">
				...
				<p class = "navbar-text pull-right">System Attendance System</p>
				</div>
	...
	<li class = "dropdown"  >
			...
			<br />
			<h2><a style="text-decoration:none;" href = "admin.php"><span class = "glyphicon glyphicon-apple"></span> User</a></h2>
			<br />
			<br />	
			<h2><a style="text-decoration:none;" href = "student.php"><span class = "glyphicon glyphicon-book"></span> Students</a></h2>
			<br />
			<br />	
			<h2><a style="text-decoration:none;" href = "calendar.php"><span class = "glyphicon glyphicon-calendar"></span> Subject</a></h2>
			</div>
		</div>
