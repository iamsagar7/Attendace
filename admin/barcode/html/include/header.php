...
<form action="<?php echo $_SERVER['REQUEST_URI']; ?>?id=121212" method="post">
    ...
    <div class="configurations">
        <section class="configurations" style="margin-left:-35%;">
            <h3>You must start in alphabet or numbers 0 to 9</h3>
            <table>
                <colgroup>
                    <col class="col1" />
                    <col class="col2" />
...
?>
                    ...
                    <tr style="display: block; width: 455px;">
                        <td style="width: 116px;"><label for="text">Student ID</label></td>
                        <td>
                            <div class="generate" style="float: left"><?php echo getInputTextHtml('text', $text, array('type' => 'text', 'maxlength'=>'14','required' => 'required')); ?> <input type="submit" value="Generate" /></div>
                            <div class="possiblechars" style="float: right; position: relative;"><a href="#" class="info characters"></a></div>
